...
useHead({
  ...
  meta: [
    ...
    { property: 'og:image', content: 'https://picsum.photos/seed/nexoma3/1200/630' },
    { name: 'robots', content: 'index, follow' }
  ],
  link: [
    { rel: 'canonical', href: 'https://nexoma.poitiers.digital/blog/chatbot-ia-commerce-poitiers' }
  ],
  script: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        image: 'https://picsum.photos/seed/nexoma3/1200/630'
      })
    }
  ]
})
...
<template>
  <div class="min-h-screen bg-[#030303] text-white">
    ...
    <div class="pt-28 pb-12 px-4 sm:px-6 lg:px-8 border-b border-white/[0.06]">
      <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
          <span class="px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-medium">Solution</span>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8">
      <div class="max-w-3xl mx-auto">
        <img
          src="https://picsum.photos/seed/nexoma3/800/400"
          alt="Chatbot IA pour commerces à Poitiers — Nexoma"
